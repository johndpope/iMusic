        ...
        if let views = superview?.subviews {
            ...
            if let tempV = tempView {
                ...
                if value > 0 {
                    ...
                    _ = imageX! + (imageSize?.width)! - badgeW * 0.5;
                    _ = imageY! - badgeW * 0.25;
...
extension UITableView {
    ...
    func md_alphaAnimation() {
        ...
        for i in 0..<cells.count {
            let cell: UITableViewCell = self.visibleCells[i]
            cell.alpha = 0.0
            UIView.animate(withDuration: 0.3, delay: TimeInterval(i)*0.05, options: UIView.AnimationOptions(rawValue: 0), animations: {
                cell.alpha = 1.0
            })
        }
    }
    ...
    func md_fallAnimation() {
        ...
        for i in 0..<cells.count {
            ...
            UIView.animate(withDuration: 0.3, delay: TimeInterval(cells.count-i)*(totalTime/TimeInterval(cells.count)), options: UIView.AnimationOptions(rawValue: 0), animations: {
                cell.transform = .identity
            })
        }
    }
    ...
    func md_shakeAnimation() {
        ...
        for i in 0..<cells.count {
            ...
            UIView.animate(withDuration: 0.4, delay: TimeInterval(i)*0.03, usingSpringWithDamping: 0.75, initialSpringVelocity: 1/0.75, options: UIView.AnimationOptions(rawValue: 0), animations: {
                cell.transform = .identity
            })
        }
    }
    ...
    func md_overTurnAnimation() {
        ...
        for i in 0..<cells.count {
            ...
            UIView.animate(withDuration: 0.3, delay: TimeInterval(i)*(totalTime/TimeInterval(cells.count)), options: UIView.AnimationOptions(rawValue: 0), animations: {    cell.layer.opacity = 1.0
    ...
    func md_roteAnimation() {
        ...
        for i in 0..<cells.count {
            let cell: UITableViewCell = cells[i]
            cell.alpha = 0.0
            UIView.animate(withDuration: 0.1, delay: TimeInterval(i)*0.25, options: UIView.AnimationOptions(rawValue: 0), animations: {
                cell.alpha = 1.0
            })
        }
    }
...
extension UISegmentedControl {
    ...
    var fontSize: CGFloat {
        ...
        set {
            let attr = [NSAttributedString.Key.font: UIFont.systemFont(ofSize: newValue)]
    ...
    var selectedTitleColor: UIColor {
        ...
        set {
            let attr = [NSAttributedString.Key.foregroundColor : newValue]
            self.setTitleTextAttributes(attr, for: .selected)
        }
    }
    ...
    var selectedBgColor: UIColor {
        ...
        set {
            let attr = [NSAttributedString.Key.backgroundColor : newValue]
            self.setTitleTextAttributes(attr, for: .selected)
        }
    }
    ...
    func setSegmentStyle(normalColor: UIColor, selectedColor: UIColor, dividerColor: UIColor) {
        ...
        let segAttributesNormal: NSDictionary = [NSAttributedString.Key.foregroundColor: UIColor(rgba: "#333333"), NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14)]
