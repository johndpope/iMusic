...
let TabBarDataSource: [[String: String]] = {
    let dic1 = ["title": NSLocalizedString("发现", comment: "").decryptString(), "imageNameS": "icon_discover_selected", "imageNameN": "icon_discover_selected(1)", "viewController": "MPDiscoverViewController"]
    let dic2 = ["title": NSLocalizedString("电台", comment: "").decryptString(), "imageNameS": "icon_fm_normal(1)", "imageNameN": "icon_fm_normal", "viewController": "MPRadioViewController"]
    let dic3 = ["title": NSLocalizedString("歌单", comment: "").decryptString(), "imageNameS": "icon_list_normal(1)", "imageNameN": "icon_list_normal", "viewController": "MPMediaLibraryViewController"]
