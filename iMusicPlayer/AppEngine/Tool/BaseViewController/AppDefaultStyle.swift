...
//    static let ThemeColor_Orange: UIColor = RGB(r: 248, g: 136, b: 52, a: 1).UIColor
    static let md_ThemeColor: UIColor = UIColor.init(rgba: "#F27638")
    /// 导航栏颜色
...
struct NotCenter{
    ...
    static let NC_RefreshRecentlyList = "NC_RefreshRecentlyList"
...
extension Color {
    ...
    static var AreaBackgroundColor: UIColor {
        return UIColor(rgba: "#FAFAFA")
    }
    
    static var FontColor_333: UIColor {
        return UIColor(rgba: "#333333")
    }
    
    static var FontColor_666: UIColor {
        return UIColor(rgba: "#666666")
    }
    
    static var FontColor_999: UIColor {
        return UIColor(rgba: "#999999")
    }
    
    static var FontColor_bbb: UIColor {
        return UIColor(rgba: "#BBBBBB")
    }
    
    static var SeperaterColor: UIColor {
        return UIColor(red: 0, green: 0, blue: 0, alpha: 0.15)
    }
    
    static var ThemeColor: UIColor {
        return UIColor(rgba: "#F27638")
    }
    
    /// 警示颜色
    static var PromptColor: UIColor {
        return UIColor(rgba: "#F82C58")
    }
}
