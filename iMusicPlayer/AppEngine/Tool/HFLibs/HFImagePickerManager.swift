...
class HFImagePickerManager: NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func show(sourceType: UIImagePickerController.SourceType = .photoLibrary, succeed:@escaping ((_ image: UIImage) -> Void)) {
    ...
    private func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        let imageData:NSData  = backImage.jpegData(compressionQuality: 0.1) as! NSData
